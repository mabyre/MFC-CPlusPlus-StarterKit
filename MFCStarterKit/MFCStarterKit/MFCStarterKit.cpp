...
BEGIN_MESSAGE_MAP(CMFCStarterKitApp, CWinApp)
	ON_COMMAND(ID_AIDE_APROPOSDE, &CMFCStarterKitDlg::OnAppAbout)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CMFCStarterKitApp

CMFCStarterKitApp::CMFCStarterKitApp()
{
...
// Le seul et unique objet CMFCStarterKitApp

CMFCStarterKitApp theApp;


// Initialisation de CMFCStarterKitApp

BOOL CMFCStarterKitApp::InitInstance()
{
